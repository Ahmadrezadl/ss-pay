...
router.post('/', async (req, res) => {
    const {store_name, game_package, receipt, sku, user_identifier, price} = req.body;
    ...
    try {
        ...
        await db.query('INSERT INTO payments (receipt, user_identifier, store_id, game_id, status,sku, price) VALUES ($1, $2, $3, $4, $5, $6, $7)',
            [receipt, user_identifier, store.id, game.id, status === 0 ? 'success' : 'failed', sku, price !== undefined ? price : null]);
